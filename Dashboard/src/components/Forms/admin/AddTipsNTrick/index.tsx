...
export const AddTipsNTrickForm: React.FC = () => {
  ...
  const handleSaveTnT = async () => {
    ...
    try {
      ...
      toast.success('Tips and trick saved.')
    } catch (error) {
  ...
  return (
    <div className="flex flex-col space-y-5">
      {(tnts?.length === 0 || !tnts) && (
        <WarningAlert>To create a new Tips and Trick, please click Add Item button bellow.</WarningAlert>
      )}
