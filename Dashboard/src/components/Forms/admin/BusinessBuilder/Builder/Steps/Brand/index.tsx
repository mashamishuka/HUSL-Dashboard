...
export const BrandDetail: React.FC<BrandDetailProps> = ({ onNext, nextText = 'Save & Continue' }) => {
    ...
    <Formik
      ...
      {({ values, handleSubmit, errors, isSubmitting, handleBlur, handleChange, setFieldValue }) => (
        <form onSubmit={handleSubmit}>
          ...
          <Button type="submit" text={nextText} loading={isSubmitting} />
        </form>
      )}
    </Formik>
  )
