...
import { createCourse } from '@src/restapi/course/mutations'
...
export const AddCourse: React.FC<DefaultModal> = ({ show, onClose, width = '42rem' }) => {
  const handleAddCourse = async (values: Record<string, any>) => {
    try {
          ...
          <div className="min-h-screen px-4 text-center">
            ...
            <Transition.Child
              ...
              <div
                ...
                <span className="block mb-5 text-xl font-semibold">Add New Course</span>
                <Formik
                  initialValues={{
                    title: ''
                  }}
