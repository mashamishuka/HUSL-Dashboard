        ...
        <div className="fixed inset-0 z-10 overflow-y-auto">
          <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
            <Transition.Child
              ...
              <Dialog.Panel className="relative px-4 pt-5 pb-4 overflow-hidden text-left transition-all transform rounded-lg shadow-xl bg-secondary sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
                ...
                <div className="mt-5 sm:mt-4 sm:ml-10 sm:flex sm:pl-4">
                  <Button onClick={() => handleProceed(true)} className="px-6 bg-danger" size="sm">
                    {proceedLabel}
                  </Button>
                  <button
                    type="button"
                    className="inline-flex justify-center w-full py-2 mt-3 text-base font-medium hover:underline sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
...
export function confirm(
  ...
  return createConfirmation(confirmable(Confirmation as any))({
    confirmation,
    proceedLabel,
    cancelLabel,
    ...options
