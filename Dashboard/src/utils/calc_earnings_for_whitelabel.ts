...
export default function calc_earnings_for_whitelabel(
  ...
  const friday_two_weeks_before_last_payout = moment.unix(last_payout_timestamp).day(7 * 2)
  const friday_two_weeks_ago = moment().day(7 * 2)
  console.log(friday_two_weeks_before_last_payout.unix(), 'hereererereerer')
