...
export const DELETE_BLOG_POST = (id: string) => {
  return `${API_URL}/blogs/${id}?token=${API_TOKEN}`
}
export const EDIT_BLOG_POST = (id: string) => {
  return `${API_URL}/blogs/${id}?token=${API_TOKEN}`
}
...
export const SINGLE_BLOG_CATEGORY = (id?: string) => {
  return `${API_URL}/blogs/categories/${id}?token=${API_TOKEN}`
}
export const EDIT_BLOG_CATEGORY = (id: string) => {
  return `${API_URL}/blogs/categories/${id}?token=${API_TOKEN}`
}
export const DELETE_BLOG_CATEGORY = (id: string) => {
  return `${API_URL}/blogs/categories/${id}?token=${API_TOKEN}`
}
